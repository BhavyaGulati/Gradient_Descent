import dataParser as dp #Load in the parser script
...
def run(initial_m=0, initial_b = 1):
    ...
    ans=m*20+b
    print("After {0} iterations b = {1}, m = {2}, error = {3}, ans = {4}".format(num_iterations, b, m, compute_total_error(b, m, points), ans))
